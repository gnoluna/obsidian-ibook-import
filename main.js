  ...
  "node_modules/sql.js/dist/sql-wasm.js"(exports, module2) {
    ...
    var initSqlJs2 = function(moduleConfig) {
      ...
      initSqlJsPromise = new Promise(function(resolveModule, reject) {
        ...
        var va = Object.assign({}, e), wa = "./this.program", ya = typeof window == "object", za = typeof importScripts == "function", Aa = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string", D = "", Ba, Ca, Da, fs, Ea, Fa;
        if (Aa)
          D = za ? require("path").dirname(D) + "/" : __dirname + "/", Fa = () => {
          ...
          }, 1 < process.argv.length && (wa = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2), typeof module2 != "undefined" && (module2.exports = e), e.inspect = function() {
            return "[Emscripten Module object]";
          };
        else if (ya || za)
          za ? D = self.location.href : typeof document != "undefined" && document.currentScript && (D = document.currentScript.src), D = D.indexOf("blob:") !== 0 ? D.substr(0, D.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", Ba = (a) => {
        ...
        }, V = (a, b) => ha(a, (b !== void 0 ? b : 511) & 1023 | 16384, 0), Rb = (a, b, c) => {
...
var initSqlJs = require_sql_wasm();
...
var IBooksData = class {
  ...
  async allBookMeta() {
    ...
    const db = new SQL.Database((0, import_fs.readFileSync)(this.libraryMetaDbFile));
    return db.exec("SELECT ZTITLE as title, ZAUTHOR as author, ZASSETID as id FROM ZBKLIBRARYASSET");
  }
  async allHighlights() {
    const SQL = await this.loadSQL();
    const db = new SQL.Database((0, import_fs.readFileSync)(this.libraryMetaDbFile));
    return db.exec(`select ZANNOTATIONASSETID as bookId,
  ...
  findDbFile(folder) {
    return path.join(folder, (0, import_fs.readdirSync)(folder).filter((file) => file.endsWith(".sqlite"))[0]);
  }
};

// src/NotesWriterModal.ts
var NotesWriterModal = class extends import_obsidian.Modal {
  constructor(app) {
    super(app);
